...
Модуль содержит список URL-адресов товаров, предположительно Используетсяых для экспериментов или отладки в рамках проекта `hypotez` для поставщика Kualastyle.
