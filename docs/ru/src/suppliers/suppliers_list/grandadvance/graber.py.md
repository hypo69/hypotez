...
- `lang_index` (int): Индекс языка, Используетсяый для локализации.
...
- `driver` (Driver): Экземпляр веб-драйвера, Используетсяый для взаимодействия с веб-страницами.
- `lang_index` (int): Индекс языка, Используетсяый для локализации контента на странице.
