...
- `src.suppliers.suppliers_list.aliexpress_com.AliPromoDeal`: Класс, предназначенный для работы с акциями и скидками AliExpress, в частности, для подготовки данных о товарах к рекламным кампаниям.
