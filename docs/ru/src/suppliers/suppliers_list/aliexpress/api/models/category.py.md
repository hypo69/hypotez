...
Модуль `category.py` содержит определения классов для представления категорий товаров, Используетсяых в API AliExpress. Он включает базовый класс `Category` и класс `ChildCategory`, представляющий дочернюю категорию с информацией о родительской категории.
