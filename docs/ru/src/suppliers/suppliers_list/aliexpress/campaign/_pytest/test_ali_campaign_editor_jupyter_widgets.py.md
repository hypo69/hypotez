...
2. Проверяется, что Возвратое значение равно `"This is a test."`.
...
4. Проверяется, что Возвратое значение равно `["file1.txt", "file2.txt"]`.
...
4. Проверяется, что Возвратое значение равно `["dir1", "dir2"]`.
