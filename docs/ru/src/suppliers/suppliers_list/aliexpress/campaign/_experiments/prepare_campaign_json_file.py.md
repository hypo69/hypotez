...
- `campaign_editor` (AliCampaignEditor): Экземпляр класса `AliCampaignEditor`, Используетсяый для редактирования кампании. Инициализируется с именем кампании и файлом конфигурации.
