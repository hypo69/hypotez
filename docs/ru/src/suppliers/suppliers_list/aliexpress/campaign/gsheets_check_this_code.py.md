...
Модуль включает класс `AliCampaignGoogleSheet`, который расширяет функциональность класса `SpreadSheet` для работы с Google Sheets, Используетсяыми в кампаниях AliExpress. Он обеспечивает автоматизацию процессов, связанных с созданием, обновлением и форматированием данных в Google Sheets, что упрощает управление рекламными кампаниями.
