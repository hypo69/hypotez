...
*   `driver`: Экземпляр класса `Driver`, Используетсяый для управления веб-браузером Firefox.
*   `graber`: Экземпляр класса `Graber`, Используетсяый для извлечения данных с сайта Morlevi.
