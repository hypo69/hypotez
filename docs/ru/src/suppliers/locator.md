...
Этот документ содержит описание формата и структуры локаторов, используемых для поиска и взаимодействия с элементами на веб-странице. Локаторы представлены в формате `JSON` и используются для автоматизации действий веб-драйвера.
