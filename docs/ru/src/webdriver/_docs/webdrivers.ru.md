# Документация по веб-драйверам проекта Hypotez
...
В этом документе представлены основные веб-драйверы, Используетсяые в проекте, и их настройки. Каждый веб-драйвер имеет свои особенности и предназначен для конкретных задач автоматизации и сбора данных. Настройки каждого драйвера можно найти в соответствующих JSON-файлах.