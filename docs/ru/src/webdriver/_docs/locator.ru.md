...
Этот документ содержит информацию о локаторах, Используетсяых для поиска и взаимодействия с веб-элементами на странице в проекте `hypotez`. Локаторы представляют собой конфигурационные объекты, которые передаются в класс `ExecuteLocator` для выполнения различных действий, таких как клики, отправка текста, извлечение атрибутов и т.д. В документе приведены примеры локаторов, описание их ключей и принципы взаимодействия с `executor`.
