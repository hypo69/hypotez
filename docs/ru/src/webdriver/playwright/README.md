...
Этот модуль предоставляет пользовательскую реализацию `PlaywrightCrawler` с использованием библиотеки Playwright. Он позволяет настраивать параметры запуска браузера, такие как user-agent, настройки прокси-сервера, размер области просмотра и другие параметры, определенные в файле `playwrid.json`.

## Подробнее

Модуль `Playwright Crawler` предназначен для автоматизации взаимодействия с веб-страницами с использованием браузера Playwright. Он предоставляет возможность настройки различных параметров браузера через файл конфигурации `playwrid.json`, что упрощает управление и повторное использование настроек. Этот модуль полезен для задач, таких как веб-скрейпинг, тестирование и автоматизация задач в браузере.

## Ключевые особенности

- **Централизованная конфигурация**: Управление конфигурацией осуществляется через файл `playwrid.json`.
- **Поддержка пользовательских параметров**: Возможность передачи пользовательских параметров во время инициализации.
...
Строка user-agent, Используетсяая для запросов браузера.
