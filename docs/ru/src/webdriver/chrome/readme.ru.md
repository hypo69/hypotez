...
Этот модуль предназначен для настройки и управления экземпляром Chrome WebDriver с использованием конфигурационных файлов и параметров. Он обеспечивает централизованное управление конфигурацией Chrome, поддержку нескольких профилей браузера и улучшенное логирование ошибок.
