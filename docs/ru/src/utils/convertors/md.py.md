...
-   `extras` (List[str], optional): Список расширений, Используетсяых библиотекой `markdown2` для расширения функциональности преобразования Markdown. По умолчанию `None`.
...
-   `extras` (List[str], optional): Список расширений, Используетсяых `markdown2` для расширения функциональности преобразования Markdown. Используется при преобразовании Markdown в HTML. По умолчанию `None`.
