...
Этот документ содержит описание структуры JSON-объекта, Используетсяого для создания или обновления данных о товарах в Prestashop через API. Он предоставляет подробную информацию о каждом поле, его назначении, формате и возможных значениях. Также включены примеры использования API на Python для загрузки данных о товаре.
