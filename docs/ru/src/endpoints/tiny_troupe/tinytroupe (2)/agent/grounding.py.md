...
- `add_folders(self, folders_paths: list) -> None`:
    - **Назначение**: Добавляет пути к папкам с файлами, Используетсяыми для "заземления".
    - **Параметры**:
...
- `add_folder(self, folder_path: str) -> None`:
    - **Назначение**: Добавляет путь к папке с файлами, Используетсяыми для "заземления".
    - **Параметры**:
...
- `add_file_path(self, file_path: str) -> None`:
    - **Назначение**: Добавляет путь к файлу, Используетсяому для "заземления".
    - **Параметры**:
