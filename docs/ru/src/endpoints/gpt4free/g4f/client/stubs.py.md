...
**Описание**: Базовый класс для моделей данных, Используетсяый для определения структуры данных и автоматической валидации типов.
...
**Описание**: Модель данных, представляющая функцию инструмента, Используетсяую в вызовах инструментов.
