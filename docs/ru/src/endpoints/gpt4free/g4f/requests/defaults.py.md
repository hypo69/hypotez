...
Модуль `defaults.py` содержит определения стандартных HTTP-заголовков, Используетсяых в запросах к серверам gpt4free. Эти заголовки имитируют запросы от веб-браузера, что помогает избежать блокировок со стороны серверов.
...
**Описание**: Стандартные HTTP-заголовки, Используетсяые по умолчанию в запросах.
...
**Описание**: HTTP-заголовки, Используетсяые для имитации запросов из WebView.
