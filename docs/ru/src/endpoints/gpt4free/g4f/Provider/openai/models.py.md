...
Модуль определяет списки моделей, Используетсяых в OpenAI. Содержит текстовые, визуальные и общие модели. Также определяет модели по умолчанию для текстовых и графических задач.
