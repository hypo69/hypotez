...
-   `label` (str): Метка провайдера, Используетсяая для идентификации.
...
-    `default_image_model` (str): Модель, Используетсяая для генерации изображений по умолчанию.
...
async def create_async_generator(
    ...
    **kwargs
    ...
    Args:
        ...
        model (str): Модель, Используетсяая для генерации изображения.
        messages (Messages): Список сообщений, Используетсяых для формирования запроса.
