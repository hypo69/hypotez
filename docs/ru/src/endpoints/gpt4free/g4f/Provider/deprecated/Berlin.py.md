...
- `_token` (str | None): Токен аутентификации, Используетсяый для доступа к API (изначально `None`).
...
- `_token` (str | None): Токен аутентификации, Используетсяый для доступа к API.
