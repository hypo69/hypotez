...
- `default_model` (str): Модель, Используетсяая по умолчанию: `"mixtral-8x7b-32768"`.
- `fallback_models` (List[str]): Список запасных моделей, Используетсяых в случае недоступности основной модели.
