...
Этот модуль содержит интеграционные тесты для проверки работы различных провайдеров, Используетсяых в библиотеке `g4f`. 
...
**Атрибуты**:
- `DEFAULT_MESSAGES` (list): Список сообщений по умолчанию, Используетсяых для запросов к чат-ботам.
