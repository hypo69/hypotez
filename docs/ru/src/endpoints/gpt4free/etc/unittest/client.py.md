...
Данный модуль содержит набор юнит-тестов для проверки функциональности асинхронного и синхронного клиентов, Используетсяых для взаимодействия с различными провайдерами моделей в проекте `hypotez`.
