...
Этот модуль определяет структуру и содержание специальных инструкций для разных моделей, Используетсяых в проекте. Инструкции задают поведение моделей в различных режимах, например, `DAN Mode` или `Developer Mode`.
...
**Описание**: Набор допустимых моделей, Используетсяых в системе.
