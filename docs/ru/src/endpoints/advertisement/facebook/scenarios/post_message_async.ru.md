...
**Параметры**:
- `d` (Driver): Экземпляр класса `Driver`, Используетсяый для управления браузером и взаимодействия с веб-страницей Facebook.
...
def promote_post(d: Driver, category: SimpleNamespace, products: List[SimpleNamespace], no_video: bool = False) -> bool:
    ...
    Args:
        d (Driver): Экземпляр класса `Driver` для взаимодействия с веб-страницей.
        category (SimpleNamespace): Объект, содержащий детали категории, Используетсяые для заголовка и описания поста.
...
**Параметры**:
- `d` (Driver): Экземпляр класса `Driver`, Используетсяый для управления браузером и взаимодействия с веб-страницей Facebook.
- `category` (SimpleNamespace): Объект, содержащий детали категории, Используетсяые для формирования заголовка и описания поста.
