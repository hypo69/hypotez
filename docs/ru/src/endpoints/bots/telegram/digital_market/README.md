...
Этот документ содержит подробное описание проекта `Digital Market Hook` - учебного Telegram-бота для цифрового интернет-магазина. Описаны функциональность бота, Используетсяые технологии, процесс установки и настройки, а также инструкции по использованию.
