...
Модуль содержит схемы данных, Используетсяые для валидации и передачи информации о товарах в административной панели Telegram-бота. Он определяет структуры для идентификации товаров (ProductIDModel) и для представления информации о товарах (ProductModel).
