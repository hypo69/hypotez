...
6.  Если столбец `payment_id` уже существует, выводит сообщение "Колонка 'payment\_id' уже существует, Пропуск добавление".
...
6.  Если столбец `payment_id` не существует, выводит сообщение "Колонка 'payment\_id' не существует, Пропуск удаление".
