...
Модуль `AuxiliaryClasses.py` содержит вспомогательные классы, Используетсяые в проекте `hypotez` для работы с Telegram ботом. В частности, он включает класс `keyboards` для создания различных типов клавиатур и класс `PromptsCompressor` для обработки и сжатия текстовых запросов (prompts).

## Подробнее

Модуль предоставляет инструменты для динамического создания клавиатур в Telegram боте и для манипулирования текстовыми запросами, Используетсяыми для генерации контента. Классы в этом модуле облегчают взаимодействие с пользователем и оптимизируют процесс обработки запросов.

## Классы

### `keyboards`

**Описание**: Класс предназначен для создания различных типов клавиатур, Используетсяых в Telegram боте.
...
**Описание**: Класс предназначен для сжатия и обработки текстовых запросов (prompts), Используетсяых для генерации контента.
