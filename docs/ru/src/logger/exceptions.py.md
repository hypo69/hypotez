...
Модуль определяет пользовательские исключения, Используетсяые в приложении. Он содержит классы исключений для обработки ошибок, связанных с операциями с файлами, полями товаров, подключениями к базам данных KeePass и ошибками веб-служб PrestaShop.
