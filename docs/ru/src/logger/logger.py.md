...
Словарь, содержащий ANSI escape-коды для различных цветов текста, Используетсяых при форматировании сообщений логгера.

### `BG_COLORS`

Словарь, содержащий ANSI escape-коды для различных цветов фона, Используетсяых при форматировании сообщений логгера.
