...
Этот модуль содержит информацию о боте Kazarinov, Используетсяом для создания PDF-отчетов Mexiron. Описывает взаимодействие между клиентом (Kazarinov) и ботом, а также схему работы бота.
