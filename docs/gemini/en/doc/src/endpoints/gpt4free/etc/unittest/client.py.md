...
- `client`:  Экземпляр асинхронного клиента `gpt4free`, Используетсяый для выполнения запросов.
...
- `client`:  Экземпляр синхронного клиента `gpt4free`, Используетсяый для выполнения запросов.
