...
Данный модуль содержит определения моделей, Используетсяых в сервисе GPT4Free. Определены стандартные модели для работы с текстом, изображениями и видеотрансляцией.  
