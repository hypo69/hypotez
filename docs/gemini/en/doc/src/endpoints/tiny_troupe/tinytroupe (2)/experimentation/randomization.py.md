...
* `random_seed` (int): Случайное число, Используетсяое для генерации случайных чисел.
...
* `random_seed` (int, optional): Случайное число, Используетсяое для генерации случайных чисел. По умолчанию: 42.
