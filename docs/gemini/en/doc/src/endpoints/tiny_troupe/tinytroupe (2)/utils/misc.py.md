...
Этот модуль содержит набор вспомогательных функций, Используетсяых в проекте `TinyTroupe`. Функции предоставляют возможности для работы с именами агентов и сред, генерации хэшей, получения уникальных идентификаторов и т.д.
