...
- Модуль собирает список категорий со страниц продавца (`get_list_categories_from_site()`).
  @todo Сделать проверку на изменение категорий на страницах продавца. Продавец может добавлять новые категории, переименовывать или удалять/прятать уже существующие. По большому счету надо держать таблицу категории `PrestaShop.categories <-> aliexpress_com.shop.categoies`
...
- Основная команда, Используетсяая в коде: `driver.execute_locator(l:dict)`.

## Изменения

- Добавлены комментарии с объяснением принципа работы функций.
- Добавлено описание параметров и Возвратых значений функций.
- Добавлены примеры использования функций.
- Добавлены комментарии с описанием Используетсяых локаторов.
- Добавлены комментарии с описанием Используетсяого вебдрайвера.
- Добавлены комментарии с описанием Используетсяого модуля логгирования.
