...
- `set_proxy(self, options: Options) -> None`: Настраивает прокси из словаря, Возвратого `get_proxies_dict`.
...
**Назначение**: Настройка прокси из словаря, Возвратого `get_proxies_dict`.
