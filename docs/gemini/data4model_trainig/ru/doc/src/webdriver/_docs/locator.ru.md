...
В данном документе представлено описание локаторов, используемых для взаимодействия с веб-элементами на страницах, и их взаимодействие с классом `ExecuteLocator`. Локаторы представляют собой конфигурационные объекты, определяющие методы поиска и действия, выполняемые над веб-элементами. Документ содержит примеры различных локаторов и подробное описание их ключей, а также объяснение их взаимодействия с `executor`.

## Подробнее

Локаторы обеспечивают гибкость и удобство при автоматизации взаимодействия с веб-элементами. Класс `ExecuteLocator` использует эти локаторы для выполнения различных операций, таких как клики, отправка данных, извлечение атрибутов и другие. Рассмотрим основные аспекты работы с локаторами и их интеграцию с `executor`.

## Классы

В данном модуле нет классов. Описание относится к структуре данных (JSON) и их использованию.

## Функции

В данном модуле нет функций. Описание относится к структуре данных (JSON) и их использованию.
