...
Этот модуль предназначен для упрощения настройки и использования Crawlee с Playwright для задач автоматизации и сбора данных в веб-браузере. Он предоставляет централизованную конфигурацию через файл `crawlee_python.json` и обеспечивает гибкость в настройке параметров браузера, прокси и других опций.
