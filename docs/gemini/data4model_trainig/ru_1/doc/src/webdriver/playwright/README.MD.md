...
Этот модуль предоставляет пользовательскую реализацию `PlaywrightCrawler` с использованием библиотеки Playwright. Он позволяет настраивать параметры запуска браузера, такие как user-agent, настройки прокси, размер viewport и другие опции, определенные в файле `playwrid.json`.

## Подробней

Модуль `Playwright Crawler` предоставляет инструменты для настройки и запуска браузера Playwright с использованием параметров, заданных в файле конфигурации `playwrid.json`. Он обеспечивает централизованное управление настройками браузера, поддержку пользовательских опций, улучшенное логирование и обработку ошибок, поддержку прокси и гибкие настройки браузера. Этот модуль предназначен для упрощения автоматизации браузера и интеграции с фреймворком Crawlee.
