...
**Расположение файла в проекте:** `hypotez/src/endpoints/gpt4free/g4f/gui/server/config.py`

**Назначение модуля:** Модуль содержит определения для специальных инструкций, используемых для настройки поведения AI моделей (например, ChatGPT) в различных режимах, таких как "DUDE", "DAN" и других. Эти инструкции позволяют изменять поведение модели, обходя ограничения и политики, установленные OpenAI.

**Качество кода:**
- **Соответствие стандартам**: 6/10
- **Плюсы**:
    - Код содержит определения для различных режимов AI моделей, что позволяет гибко настраивать их поведение.
    - Инструкции для каждого режима хорошо структурированы и понятны.
- **Минусы**:
    - Отсутствует документация модуля и отдельных переменных.
    - Код содержит инструкции на английском языке, что не соответствует требованиям.
...
2.  **Добавить документацию для переменных**:
    - Описать назначение переменной `special_instructions`.
3.  **Перевести инструкции на русский язык**:
    - Перевести все инструкции и описания режимов на русский язык.
...
```python
"""
Модуль содержит определения для специальных инструкций, используемых для настройки поведения AI моделей.
========================================================================================================

Модуль содержит словарь `special_instructions`, который используется для настройки поведения AI моделей (например, ChatGPT)
в различных режимах, таких как "DUDE", "DAN" и других. Эти инструкции позволяют изменять поведение модели,
обходя ограничения и политики, установленные OpenAI.

Пример использования
----------------------

>>> from src.endpoints.gpt4free.g4f.gui.server.config import special_instructions
>>> print(special_instructions.keys())
dict_keys(['default', 'gpt-dude-1.0', 'gpt-dan-1.0', 'gpt-dan-2.0', 'gpt-math-1.0', 'gpt-dev-2.0', 'gpt-evil-1.0'])
"""
from typing import List, Dict

from src.logger import logger

# Словарь, содержащий специальные инструкции для различных режимов AI моделей.
