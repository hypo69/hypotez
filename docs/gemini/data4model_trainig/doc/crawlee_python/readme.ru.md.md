### Анализ кода модуля `hypotez/src/webdriver/crawlee_python/readme.ru.md`
...
Чтобы использовать `CrawleePython` в своем проекте, просто импортируйте его и инициализируйте:
