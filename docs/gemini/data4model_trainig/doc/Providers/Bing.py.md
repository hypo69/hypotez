```python
## \\file /src/endpoints/freegpt-webui-ru/g4f/Provider/Providers/Bing.py
# -*- coding: utf-8 -*-

Этот код реализует интерфейс для взаимодействия с Bing AI и предоставляет функциональность для создания и управления диалогами.
"""
...
def _format(msg: Dict) -> str:
    """Форматирование сообщения в строку JSON с разделителем."""
