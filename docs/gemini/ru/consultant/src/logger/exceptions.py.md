...
1.  **Документирование классов исключений**:
    ...
    - Описать параметры и Возвратые значения для методов `__init__` и других методов.
...
4.  **Аннотация типов**:
    - Добавить аннотации типов для переменных и Возвратых значений, где это необходимо.
...
"""
Модуль определяет пользовательские исключения, Используетсяые в приложении.
=======================================================================
