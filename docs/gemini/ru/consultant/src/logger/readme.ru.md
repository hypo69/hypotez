...
- **Минусы**:
  ...
  - Не все функции имеют docstring с описанием параметров и Возвратых значений.
...
- Добавить docstring для всех классов и методов, включая описание параметров, Возвратых значений и возможных исключений.
...
# создание экземпляр JsonFormatter
