...
- **Минусы**:
    ...
    - В некоторых docstring отсутствует описание Возвратых значений и исключений.
...
1.  **Аннотации типов**:
    - Добавить аннотации типов для всех параметров функций и Возвратых значений, где это отсутствует.

2.  **Docstring**:
    - Дополнить docstring описанием Возвратых значений и возможных исключений для каждой функции и метода.
    - Перевести все docstring на русский язык.

3.  **Использование кавычек**:
    - Привести код к единому стилю использования одинарных кавычек (`'`).

4.  **Удаление неИспользуетсяых аргументов**:
