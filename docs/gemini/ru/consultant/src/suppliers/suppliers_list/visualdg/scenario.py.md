...
2. **Функция `get_list_products_in_category`**:
   - Добавить полное описание функции, включая параметры и Возвратые значения.
...
4. **Функция `get_list_categories_from_site`**:
   - Добавить docstring с описанием назначения функции, аргументов и Возвратых значений.
