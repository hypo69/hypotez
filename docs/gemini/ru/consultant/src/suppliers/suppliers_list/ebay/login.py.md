...
- **Минусы**:
    ...
    - Несоответствие стандарту оформления docstring (отсутствие описания параметров, Возвратых значений и т.д.).
...
2.  **Заполнить docstring**: Добавить описание назначения модуля, его функциональности, Используетсяых классов и функций.
...
7.  **Документировать функции и классы**: Добавить docstring для каждой функции и класса, описывая их параметры, Возвратые значения и возможные исключения.
