...
- **Минусы**:
    ...
    - Отсутствуют аннотации типов для переменных и Возвратых значений функций.
...
2.  **Добавить docstring для всех функций и классов.** Docstring должны содержать описание назначения, аргументов, Возвратых значений и возможных исключений.
...
5.  **Добавить аннотации типов для переменных и Возвратых значений функций.** Это улучшит читаемость и поможет избежать ошибок.
