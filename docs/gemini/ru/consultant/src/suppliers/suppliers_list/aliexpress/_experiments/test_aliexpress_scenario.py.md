...
1. **Документирование кода**:
   ...
   - Описание параметров и Возвратых значений должны быть на русском языке.
...
3. **Аннотация типов**:
   ...
   - Указать типы Возвратых значений для функций `start_supplier` и `start_product`.

4. **Удаление неИспользуетсяых переменных**:
...
test_products_list: List[str] = ['https://s.click.aliexpress_com.com/e/_oFLpkfz',
