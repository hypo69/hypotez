...
7.  **Документировать функцию `get_next_deal`**: Добавить docstring для функции `get_next_deal` с описанием ее аргументов, Возвратого значения и возможных исключений.
...
"""
Модуль для парсинга таблицы xls, сгенерированной в личном кабинете portals.aliexpress_com.com.
=========================================================================================
