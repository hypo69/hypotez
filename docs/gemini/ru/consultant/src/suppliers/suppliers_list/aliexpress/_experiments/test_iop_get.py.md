...
2.  **Документирование функций**:
    - Добавить docstring к каждой функции, описывающий её параметры, Возвратое значение и возможные исключения.
3.  **Удалить или переработать закомментированный код**:
    - Удалить неИспользуетсяый закомментированный код, чтобы улучшить читаемость.
