...
1.  **Добавить docstrings для функций**:
    *   Описать назначение каждой функции, параметры и Возвратые значения.
2.  **Добавить аннотации типов**:
    *   Указать типы параметров и Возвратых значений для повышения читаемости и облегчения отладки.
...
6.  **Удалить неИспользуетсяые комментарии**:
