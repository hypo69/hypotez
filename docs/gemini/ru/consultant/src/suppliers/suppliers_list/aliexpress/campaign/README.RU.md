...
2.  **Документировать каждую функцию и класс**:
    - Для каждой функции и класса добавить docstring, описывающий входные параметры, Возвратые значения, возможные исключения и примеры использования.
    - Использовать аннотации типов для параметров и Возвратых значений.
