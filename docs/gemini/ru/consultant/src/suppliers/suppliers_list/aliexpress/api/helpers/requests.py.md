...
- **Минусы**:
    ...
    - Не используются аннотации типов для параметров и Возвратых значений функций.
...
1.  **Добавить документацию модуля и функций**:
    - Описать назначение модуля, каждой функции, параметры и Возвратые значения.
2.  **Добавить аннотации типов**:
    - Указать типы данных для всех параметров и Возвратых значений функций.
...
def api_request(request, response_name: str, attempts: int = 1):
    ...
    Args:
        ...
        response_name (str): Ключ, Используетсяый для извлечения данных из ответа.
