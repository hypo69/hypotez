...
1.  **Добавить docstring для модуля**:
    ...
    *   Добавить информацию об Используетсяых зависимостях.
2.  **Добавить docstring для всех функций и методов**:

    *   Описание должно быть на русском языке.
    *   Указать параметры, Возвратые значения и возможные исключения.
...
8.  **Удалить закомментированный код**:
    ...
    *   Удалить неИспользуетсяый код, чтобы не захламлять файл.
