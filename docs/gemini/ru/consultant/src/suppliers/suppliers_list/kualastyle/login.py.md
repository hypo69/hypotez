...
- **Минусы**:
  ...
  - Некорректное использование docstring для функций: отсутствуют описания параметров и Возвратых значений, а также отсутствует описание того, что именно делает функция.
...
- Переписать docstring для функций `login` и `close_pop_up`, указав описание параметров, Возвратых значений и назначения функций.
