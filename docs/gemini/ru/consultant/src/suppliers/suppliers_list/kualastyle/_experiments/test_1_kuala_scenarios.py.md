...
- **Минусы**:
    ...
    - Не указаны типы для переменных и Возвратых значений функций.
...
2.  **Добавить docstring для функций**:
    - Описать параметры и Возвратые значения функций.
    - Описать возможные исключения.

3.  **Удалить избыточные и повторяющиеся docstring**:
    - Убрать лишние и неинформативные docstring.

4.  **Указать типы для переменных и Возвратых значений функций**:
    - Использовать аннотации типов для всех переменных и Возвратых значений функций.
