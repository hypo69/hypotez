...
3. **Рекомендации по улучшению**:
   ...
   - Добавить docstring для всех функций и методов, включая описание аргументов, Возвратых значений и возможных исключений.
   ...
   - Использовать константы для URL и других часто Используетсяых значений.
...
""" supplier - экземпляр класса `Supplier`, Используетсяый на протяжении всего кода """
