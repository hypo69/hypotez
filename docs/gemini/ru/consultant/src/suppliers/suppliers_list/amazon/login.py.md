...
#### **3. Рекомендации по улучшению**:
   - Добавить docstring к функции `login` с описанием параметров, Возвратого значения и возможных исключений.
   - Добавить аннотации типов для переменных и параметров функции `login`.
   - Явно указать Возвратый тип `None` в случаях, когда функция ничего не возвращает.
