...
5.  **Реализовать функцию `start_supplier`**:
    ...
    - Добавить docstring для функции `start_supplier` с описанием аргументов, Возвратого значения и возможных исключений.
...
9. **Добавить документацию к функциям**:
    - Добавить подробные docstring к функциям, описывающие их назначение, аргументы, Возвратые значения и возможные исключения.
