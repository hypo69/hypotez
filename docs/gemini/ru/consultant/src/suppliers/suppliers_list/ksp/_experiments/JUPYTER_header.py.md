...
- **Минусы**:
    ...
    - Некорректное форматирование docstring (отсутствие описания модуля, параметров, Возвратых значений).
...
2.  **Правильно оформить docstring**:
    - Добавить описание модуля, параметров функций, Возвратых значений и возможных исключений в формате, указанном в инструкции.
...
9.  **Добавить аннотации типов**:
    - Добавить аннотации типов для всех переменных и Возвратых значений функций.
...
11. **Переписать docstring для функции `start_supplier`**:
    - Добавить подробное описание параметров и Возвратого значения.
