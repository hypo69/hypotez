...
2. **Типизация**:
   - Добавить аннотации типов для всех аргументов и Возвратых значений функций, где это необходимо (например, `get_list_categories_from_site(s: Supplier) -> list[str]`).
