...
1.  **Docstrings**:
    *   Дополнить docstrings для всех функций и методов, включая описание аргументов, Возвратых значений и возможных исключений.
...
8.  **Удалить неИспользуетсяый код**:
    *   Удалить или закомментировать неИспользуетсяый код, чтобы избежать путаницы.
