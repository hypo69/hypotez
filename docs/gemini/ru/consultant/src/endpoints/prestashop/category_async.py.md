...
1. **Документация**:
   - Добавить docstring для класса `PrestaCategoryAsync` и метода `get_parent_categories_list_async`, включая описание параметров, Возвратых значений и возможных исключений.
