...
Этот документ описывает структуру локаторов, используемых для поиска и взаимодействия с веб-элементами на странице, а также их взаимодействие с классом `executor`.
