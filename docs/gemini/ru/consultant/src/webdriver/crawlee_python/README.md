...
1.  **Добавить docstring**: Добавьте docstring ко всем классам, функциям и методам, описывающие их назначение, аргументы, Возвратые значения и возможные исключения.
