...
- **Минусы**:
  - Не все методы и функции имеют подробные docstring с описанием аргументов, Возвратых значений и возможных исключений.
...
1. **Документирование**:
   - Дополнить docstring для всех методов и функций с описанием аргументов, Возвратых значений и возможных исключений.
