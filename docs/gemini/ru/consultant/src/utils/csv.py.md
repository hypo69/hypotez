...
3.  **Docstring**:
    - Добавь более подробные docstring для каждой функции, включая описание аргументов, Возвратых значений и возможных исключений.
...
5.  **Комментарии**:
    ...
    - Избегай общих фраз вроде "получаем" или "делаем". Вместо этого используй более конкретные термины, например "извлекаем", "Проверка", "выполняем".
