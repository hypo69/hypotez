...
- **Минусы**:
    ...
    - Не все переменные и Возвратые значения аннотированы типами.
...
1.  **Добавить docstring**:
    ...
    - Добавить docstring для каждой функции, описывающий аргументы, Возвратые значения и возможные исключения.
...
7.  **Использовать константы**:
    - Определить константы для часто Используетсяых строк (например, префиксы для удаления строк в функции `clean`).

8.  **Аннотации типов**:
    - Добавить аннотации типов для всех переменных и Возвратых значений, где это возможно.
