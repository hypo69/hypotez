...
- **Минусы**:
  ...
  - Не все функции содержат подробные docstring с описанием аргументов и Возвратых значений.
...
2.  **Улучшить docstring для функций**: Добавить подробное описание аргументов, Возвратых значений и возможных исключений. Использовать русский язык в docstring.
...
def main():
    ...
    project_structure_directory: Path = Path(src_directory , 'prod')  # создание папку 'prod'
