...
1. **Добавить docstring**:
   - Добавить docstring к каждой функции, включая описание аргументов, Возвратого значения и возможных исключений.
...
Используетсяого в проектах mdbook для навигации по книге. Он рекурсивно обходит
