...
*   `email.mime.text.MIMEText`: Класс, Используетсяый для создания MIME-объектов, представляющих текст электронного письма.
...
*   `typing`: Используется для статической типизации, что позволяет улучшить читаемость и поддерживаемость кода за счет указания типов данных аргументов и Возвратых значений функций.
