...
Описание
-------------------------
Модуль `make_summary.py` предназначен для автоматического создания файла `SUMMARY.md`, Используетсяого для компиляции документации. Он рекурсивно обходит указанную директорию с `.md` файлами и генерирует оглавление, фильтруя файлы по указанному языку (русский или английский).
