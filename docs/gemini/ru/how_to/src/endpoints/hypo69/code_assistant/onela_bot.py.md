...
В этом примере мы создание экземпляр класса `OnelaBot`, а затем запускаем его в режиме опроса. Это означает, что бот постоянно будет проверять наличие новых обновлений от Telegram и обрабатывать их. 
