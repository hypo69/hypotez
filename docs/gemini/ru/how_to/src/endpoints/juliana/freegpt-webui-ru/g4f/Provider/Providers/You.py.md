...
2. **Определение констант:** Определяются константы `url` и `model`, которые представляют URL-адрес API You.com и название модели, Используетсяой для генерации текста, соответственно. 
...
# создание объект провайдера You.com
provider = You()
