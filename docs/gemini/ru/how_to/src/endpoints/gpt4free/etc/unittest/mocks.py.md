...
Описание
-------------------------
Блок кода предоставляет набор моков для различных провайдеров и моделей, Используетсяых в рамках библиотеки g4f, которая взаимодействует с API gpt4free. Моки предназначены для тестирования функций библиотеки без фактического обращения к API.
