...
3. **Отправка запроса**: Используй метод `create_async_generator` для отправки запроса с указанием модели, сообщений (в виде списка словарей) и прокси (опционально).
...
- Используй прокси, если ваш IP-адрес заблокирован на `gptalk.net`.
