...
3. **Выбор модели:** Выберите желаемую модель для генерации текста или изображения. Используй атрибуты `text_models` и `image_models` для получения списка доступных моделей. 
...
6. **Обработка результатов:** Используй цикл `for` для получения результатов генерации текста или изображения из асинхронного генератора.
