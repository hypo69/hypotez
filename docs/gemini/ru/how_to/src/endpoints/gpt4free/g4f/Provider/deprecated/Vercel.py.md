...
Описание
-------------------------
Данный код реализует провайдера Vercel для API, Используетсяого в проекте. Провайдер Vercel позволяет взаимодействовать с моделями, доступными через платформу Vercel, включая модели, обученные на основе GPT-3.5 и GPT-4. 
...
# создание объект провайдера Vercel
provider = Vercel()

# Определение сообщения для модели
messages: Messages = [
