...
2. **Добавление отношений:** Используй метод `add_relation` для добавления отношений между двумя агентами. Метод принимает в качестве аргументов двух агентов и имя отношения.
