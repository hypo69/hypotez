...
2. **Рандомизация**: Используй метод `randomize(i, a, b)` для рандомизации выбора между двумя вариантами. Метод возвращает пару 
    рандомизированных вариантов и сохраняет информацию о том, были ли они поменяны местами для дальнейшего декодирования.
3. **Декодирование**: Используй метод `derandomize(i, a, b)` для декодирования рандомизированных вариантов. Метод возвращает пару 
    истинных вариантов, исходя из информации о рандомизации, сохраненной при выполнении `randomize`.
4. **Декодирование имени**: Используй метод `derandomize_name(i, blind_name)` для декодирования имени варианта, выбранного 
