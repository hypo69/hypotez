...
Шаги выполнения
-------------------------
1. **Поиск существующих проблем**: Перед созданием новой проблемы, поищите существующие, чтобы избежать дублирования. Используй поле поиска в разделе "Issues" на GitHub для поиска по ключевым словам, связанным с вашей проблемой.
