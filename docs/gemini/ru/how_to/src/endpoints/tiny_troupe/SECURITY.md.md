...
Описание
-------------------------
[Этот блок кода представляет собой стандартный шаблон безопасности, Используетсяый Microsoft для всех своих репозиториев на GitHub. Он предоставляет информацию о том, как сообщать о найденных уязвимостях в коде, и объясняет принципы, которым следует Microsoft при обработке таких отчетов.]
