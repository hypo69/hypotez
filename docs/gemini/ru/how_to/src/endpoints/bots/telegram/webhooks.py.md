...
* Используй функцию `telegram_webhook_async()` для обработки входящих запросов от Телеграма.
* Используй объект `application` для обработки `Update`-объектов и управления ботом.