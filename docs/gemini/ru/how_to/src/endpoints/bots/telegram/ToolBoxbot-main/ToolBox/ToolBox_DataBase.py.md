...
3. **Вставка/Обновление данных**: Используй метод `insert_or_update_data()` для добавления или обновления данных в таблице. Передайте идентификатор записи (`record_id`) и словарь с данными (`values`).
