...
### Описание
-------------------------
Класс `FacebookFields` предназначен для хранения и предоставления доступа к полям, Используетсяым в объявлениях и событиях Facebook. Он загружает данные из файла `facebook_fields.json`, расположенного в `src/advertisement/facebok/`, и делает их доступными в виде атрибутов класса.
...
-------------------------
- Класс `FacebookFields` предоставляет удобный способ получить доступ к полям Facebook, Используетсяым в проекте.
