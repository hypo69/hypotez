...
2. **Настройка конфигурации**:
    ...
    - Используй пример конфигурации из документации в качестве основы.
...
4. **Запуск CrawleePython**:
    - Используй метод `run()` для запуска CrawleePython и передачи списка URL-адресов для обработки.
...
- Используй `options` для передачи дополнительных аргументов командной строки браузеру.