...
3. **Инициализация WebDriver**: Используй WebDriver для запуска Firefox с указанными настройками.
...
3. **Инициализация WebDriver**: Используй WebDriver для запуска Chrome с указанными настройками.
...
3. **Инициализация WebDriver**: Используй WebDriver для запуска Edge с указанными настройками.
...
3. **Инициализация Playwright**: Используй Playwright для запуска браузера с указанными настройками.
...
3. **Инициализация и парсинг**: Используй BeautifulSoup для парсинга HTML и XPath для извлечения нужных элементов.
