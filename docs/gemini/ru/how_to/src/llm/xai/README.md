...
3. **Chat Completion**: Используй метод `chat_completion` для генерации ответов от моделей xAI.
4. **Streaming Chat Completion**: Используй метод `stream_chat_completion` для получения потоковых ответов от моделей xAI.
