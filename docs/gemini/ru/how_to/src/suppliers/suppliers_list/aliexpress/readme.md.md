...
2. **Выбор метода взаимодействия**: Выберите метод взаимодействия с AliExpress:
    - `webdriver`: Используй `Driver` для прямого доступа к HTML-страницам товара и выполнения скриптов сбора данных.
    - `api`: Используй API для получения партнерских ссылок и кратких описаний товаров.
