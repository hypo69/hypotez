...
2. **Доступ к данным о товаре:**
   - Используй атрибуты объекта `Product`, чтобы получить доступ к информации о товаре.

3. **Использование данных:**
   - Используй полученную информацию для отображения  деталей о товаре,  фильтрации товаров,  выполнения других задач.
