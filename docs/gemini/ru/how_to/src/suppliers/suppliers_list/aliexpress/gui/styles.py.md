...
В этом примере мы создание виджет QLabel с текстом "Hello, World!" и затем устанавливаем его фиксированный размер 200 пикселей по ширине и 50 пикселей по высоте с помощью функции `set_fixed_size`.