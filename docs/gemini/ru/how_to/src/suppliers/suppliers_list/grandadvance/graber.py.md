...
1. **Инициализация:**  Создайте экземпляр класса `Graber`, передав в конструктор объект WebDriver и индекс языка. 
    - `driver`: объект WebDriver, Используетсяый для взаимодействия с браузером.
...
3. **Использование методов:**  Используй методы класса `Graber` для сбора данных с Grandadvance. 
