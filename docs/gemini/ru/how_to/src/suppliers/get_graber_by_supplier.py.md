...
3. **Используй функцию `get_graber_by_supplier_url` для получения грабера по URL:**
...
4. **Используй функцию `get_graber_by_supplier_prefix` для получения грабера по префиксу:**
