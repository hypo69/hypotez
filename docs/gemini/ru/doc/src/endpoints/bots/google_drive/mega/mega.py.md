...
- ## Классы
  - ### `Mega`
    ...
    - **Атрибуты**:
      ...
      - `master_key`: Основной ключ, Используетсяый для шифрования/дешифрования данных.
      - `rsa_priv_key`: Частный ключ RSA, Используетсяый для дешифрования сессионного ID.
...
class Mega(object):
    ...
    Attributes:
        ...
        master_key (list): Основной ключ, Используетсяый для шифрования/дешифрования данных.
        rsa_priv_key (list): Частный ключ RSA, Используетсяый для дешифрования сессионного ID.
