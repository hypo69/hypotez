...
4.  **Парсинг страницы**:
    *   Если парсинг успешен, конвертирует поля продукта.
    *   Если парсинг не удался, регистрирует ошибку парсинга.
5.  **Конвертация данных**:
    *   Если конвертация успешна, сохраняет данные продукта.
    *   Если конвертация не удалась, регистрирует ошибку конвертации.
6.  **Сохранение данных**:
    *   Если данные сохранены, добавляет их в список продуктов.
