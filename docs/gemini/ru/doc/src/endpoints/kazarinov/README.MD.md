...
- Сценарии, Используетсяые в этом модуле, реализованы в подмодуле `scenarios`, и они отвечают за различные этапы процесса создания PDF-файлов.
...
def handle_message(update: Update, context: CallbackContext):
    ...
    if update.message.text:
        ...
        # Проверка, содержит ли сообщение команду "/create_pdf"
