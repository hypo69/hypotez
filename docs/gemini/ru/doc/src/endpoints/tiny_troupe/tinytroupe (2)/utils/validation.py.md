...
Этот модуль содержит набор функций для валидации и санитации данных, Используетсяых в компоненте `tinytroupe`. Он предоставляет инструменты для проверки допустимости полей, удаления недопустимых символов из строк и ограничения глубины вложенности словарей.
