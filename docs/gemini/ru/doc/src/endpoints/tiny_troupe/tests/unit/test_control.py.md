...
**Описание**: Класс `Simulation` представляет собой симуляцию TinyTroupe. Он хранит информацию о состоянии симуляции, включая ее статус, трассировку выполнения, кэшированную трассировку, время последней контрольной точки, список агентов и список Используетсяых инструментов.
...
- `tools` (list): Список инструментов, Используетсяых в симуляции.
