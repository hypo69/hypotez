...
**Описание**: 
Функция-тест, которая проверяет основные характеристики API по умолчанию, Используетсяого библиотекой `TinyTroupe`.
**Наследует**: 
...
**Назначение**: 
Проверяет основные характеристики API по умолчанию, Используетсяого библиотекой `TinyTroupe`.
