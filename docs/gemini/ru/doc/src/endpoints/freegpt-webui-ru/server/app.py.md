...
- `template_folder`: Определяет путь к папке с HTML-шаблонами, Используетсяыми в веб-приложении. 
...
В этом примере мы создание объект Flask, устанавливаем директорию для шаблонов и объявляем маршрут `/` для отображения страницы "Hello, world!". 
