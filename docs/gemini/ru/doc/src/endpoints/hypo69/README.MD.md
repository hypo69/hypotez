...
-  `model` (str): Название модели AI, Используетсяой для чата.
...
-  `model` (str): Название модели AI, Используетсяой для обучения.
...
-  `model` (str): Название модели AI, Используетсяой для анализа.
