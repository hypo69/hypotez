...
Этот модуль предоставляет типы для работы с различными данными, Используетсяыми в проекте. Он используется для повышения читаемости и корректности кода, а также для облегчения проверки типов.
