...
Этот модуль содержит определения типов для различных конфигурационных параметров, Используетсяых в проекте `hypotez`. Он определяет классы `BaseModel` (pydantic) для представления различных конфигурационных параметров, таких как:
...
Этот модуль обеспечивает типизированные модели для представления различных конфигурационных параметров, Используетсяых в проекте. Типизированные модели предоставляют структурированный способ определения параметров и их типов.
