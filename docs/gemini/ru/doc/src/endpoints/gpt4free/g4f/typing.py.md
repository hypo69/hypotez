...
Этот модуль содержит набор типов, Используетсяых для определения типов данных и параметров различных функций и классов в проекте GPT4Free. Типизация позволяет повысить  безопасность кода, а также  улучшить его читаемость. 
