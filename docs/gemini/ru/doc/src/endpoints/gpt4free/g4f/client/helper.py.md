...
Этот модуль содержит набор вспомогательных функций, Используетсяых в модуле `gpt4free`. Он предоставляет функции для обработки текста, фильтрации JSON-данных и работы с асинхронными генераторами.
