...
Данный модуль предоставляет инструменты для работы с HAR-файлами, которые используются для хранения информации о сетевых запросах и ответах. В частности, он предназначен для извлечения токенов аутентификации, куки и других параметров из HAR-файлов, Используетсяых в сервисах OpenAI.
