...
Этот файл содержит описание локаторов, которые используются в проекте `hypotez` для взаимодействия с веб-элементами. Локаторы - это конфигурационные объекты, определяющие, как найти и взаимодействовать с веб-элементами на странице. Они передаются в класс `ExecuteLocator` для выполнения различных действий, таких как клики, отправка сообщений, извлечение атрибутов и т.д.

## Локаторы

Локаторы предоставляют гибкий инструмент для автоматизации взаимодействия с веб-элементами. 
`Executor` обеспечивает их выполнение с учетом всех параметров и условий.
...
**Описание**: Закрыть баннер (pop-up окно), если он появился на странице.
...
**Описание**: Извлечь URL дополнительных изображений.
...
**Описание**: Сделать скриншот изображения по умолчанию.
...
**Описание**: Извлечь текст внутри элемента, содержащего SKU.
