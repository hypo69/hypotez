...
Этот документ описывает, как локаторы используются для поиска и взаимодействия с веб-элементами на странице, а также их взаимодействие с классом `ExecuteLocator`.
...
1.  [Примеры локаторов](#примеры-локаторов)
...
2.  [Взаимодействие с `executor`](#взаимодействие-с-executor)
