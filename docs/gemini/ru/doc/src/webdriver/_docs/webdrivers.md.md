...
Каждый вебдрайвер имеет свои параметры, которые можно настроить в соответствующих файлах JSON. В этом документе описаны  настройки для каждого вебдрайвера, а также пример конфигурационных файлов.
...
Этот документ предоставил обзор всех вебдрайверов, доступных в проекте, их настроек и опций. Используйте эту информацию для настройки вебдрайверов в соответствии с вашими требованиями.