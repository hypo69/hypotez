...
**Важно**: Не храните конфиденциальные данные, такие как имя пользователя и пароль, напрямую в коде. Используй переменные окружения для безопасного хранения этих данных.
