...
2. Используй API-клиент для работы с API AliExpress.
3. Используй Selenium Webdriver для автоматизации действий на веб-страницах AliExpress.
4. Используй утилитные функции и классы из модуля `utils`.
