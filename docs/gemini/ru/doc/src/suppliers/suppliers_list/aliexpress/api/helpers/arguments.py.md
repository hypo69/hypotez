...
Этот модуль предоставляет набор вспомогательных функций для работы с аргументами, Используетсяыми в API AliExpress. 
...
Модуль `aliexpress_com.api.helpers.arguments` играет важную роль в обеспечении правильной работы с API, 
