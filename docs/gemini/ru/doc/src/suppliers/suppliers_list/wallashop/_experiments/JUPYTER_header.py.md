...
- `supplier_prefix` (str): Префикс поставщика, Используетсяый для идентификации поставщика. Например, "aliexpress" или "wallashop".
- `locale` (str): Язык локализации, Используетсяый для получения данных о товарах. Например, "ru" или "en".
