...
Этот документ описывает структуру и использование локаторов для извлечения данных с `HTML`-страниц в проекте `hypotez`. Локаторы определяют, как находить и взаимодействовать с элементами на странице, такими как текст, изображения и кнопки.

## Подробнее

Локаторы используются для определения местоположения элементов на веб-странице, чтобы извлечь необходимую информацию или выполнить действия. Они хранятся в формате `JSON` и используются веб-драйвером для взаимодействия с элементами. Этот файл документации описывает структуру этих локаторов и способы их использования.
