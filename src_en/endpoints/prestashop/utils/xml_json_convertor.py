...
def presta_fields_to_xml(presta_fields_dict: dict) -> str:
    ...
    dynamic_key = next(iter(presta_fields_dict))  # We take the first key (for example, 'Product', 'Category', etc.)

    # We create a root element "Prestashop"
