...
class FacebookPromoter:
    ...
    def promote(self, group: SimpleNamespace, item: SimpleNamespace, is_event: bool = False, language: str = None, currency: str = None) -> bool:
        ...
        # Installing the attributes of an event or message
        if is_event:
        ...
        # Updating the group data after publication
    ...
    def get_category_item(self, campaign_name: str, group: SimpleNamespace, language: str, currency: str) -> SimpleNamespace:
        ...
        if self.promoter == 'aliexpress':
            ...
            adv_categories = list(vars(adv.category).items())  # We will convert to the mixing list
            random.shuffle(adv_categories)  # Mix the categories
            ...
            for ad_name, ad in adv_categories:
                ...
                if _img:
                    _img = _img if isinstance(_img, str) else _img[0]  # I take only the first image
