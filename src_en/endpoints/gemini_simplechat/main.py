...
"""A simple interface assembled on the basis of `fast_api`
=====================================================
...
class Config:
    ...
    try:
        ...
        GEMINI_MODEL_NAME:str = config.gemini_model_name # 'Gemini-1.5-Flash-001-Tuning' # <-this is a model that learns to my code
