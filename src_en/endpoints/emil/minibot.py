...
"""A minibot that accepts one-tab.com a link and puts it on processing in `pipeline`
==========================================================================================================
...
class Config:
    ...
    CHANNEL_ID = '@onela'
    PHOTO_DIR = Path(ENDPOINT / 'assets') # <- Generated AI pictures for a concrete supplier
...
class BotHandler:
    ...
    def _send_user_flowchart(self, bot, chat_id):
        """Sending the user_flowchart scheme."""
    ...
    def send_pdf(self, bot, message, pdf_file):
        """Team processing /SENDPDF for sending PDF."""
        try:
    ...
    def _transcribe_voice(self, file_path):
        """Transcraft of voice message (plug)."""
