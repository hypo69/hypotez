## \file /src/suppliers/suppliers_list/ads_tec_iit_com/graber_via_pydoll.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
Module for collecting product data from Aliexpress using the `pydoll` library.
=========================================================================================

rst```
.. module:: src.suppliers.suppliers_list.ads_tec_iit_com.graber_via_pydoll
```
...
class Graber(GraberSupplier):
    ...
    def __init__(self):
        super().__init__(supplier_prefix = 'ads-tec-iit.com')
