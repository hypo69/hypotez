## \file /src/suppliers/suppliers_list/etzmaleh_co_il/login.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.etzmaleh_co_il.login
    :platform: Windows, Unix
    :synopsis: Webdriver-based login interface for Etzmaleh (Israel).

Etzmaleh (Israel) Login Interface
=========================================================================================

This module provides a login interface for Etzmaleh (Israel) using a webdriver.
...
```python
    ...
    from src.suppliers.suppliers_list.etzmaleh_co_il.login import login
    ...
    if login(supplier_instance):
        print("Successfully logged in to Etzmaleh (Israel).")
    else:
        print("Failed to log in to Etzmaleh (Israel).")
...
:version: 1.0.0
:location: suppliers/suppliers_list/etzmaleh_co_il/login.py
"""
