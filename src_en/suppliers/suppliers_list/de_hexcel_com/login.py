## \file /src/suppliers/suppliers_list/de_hexcel_com/login.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.de_hexcel_com.login
    :platform: Windows, Unix
    :synopsis: Webdriver-based login interface for Hexcel (Germany).

Hexcel (Germany) Login Interface
=========================================================================================

This module provides a login interface for Hexcel (Germany) using a webdriver.
...
```python
    ...
    from src.suppliers.suppliers_list.de_hexcel_com.login import login
    ...
    if login(supplier_instance):
        print("Successfully logged in to Hexcel (Germany).")
    else:
        print("Failed to log in to Hexcel (Germany).")
...
:version: 1.0.0
:location: suppliers/suppliers_list/de_hexcel_com/login.py
"""