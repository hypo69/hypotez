# # \file /src/suppliers/suppliers_list/cisco_com/categories_crawler.py
# -*- coding: utf-8 -*-
# ! .pyenv/bin/python3
""".. module:: src.suppliers.suppliers_list.cisco_com.categories_crawler
    :platform: Windows, Unix
    :synopsis: Module for collecting products from Cisco category pages via webdriver.

Cisco Category Page Product Scraper
=========================================================================================

This module is responsible for scraping product data from Cisco category pages using a webdriver.
...
- The module collects a list of categories from the seller's pages (`get_list_categories_from_site()`).
  ...
  Essentially, a table of `PrestaShop.categories <-> cisco.shop.categories` should be maintained.
...
:version: 1.0.0
:location: suppliers/suppliers_list/cisco_com/categories_crawler.py"""
