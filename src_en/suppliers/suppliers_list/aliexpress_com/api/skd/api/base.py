## \file /src/suppliers/suppliers_list/aliexpress_com/api/skd/api/base.py
# -*- coding: utf-8 -*-
 # <- venv win
"""
.. module:: src.suppliers.suppliers_list.aliexpress_com.api.skd.api.base
    :platform: Windows, Unix
    :synopsis: Base classes for AliExpress SDK API.

This module provides base classes and utilities for interacting with the AliExpress SDK API.
It includes functionalities for signing requests, handling multipart forms, and managing API exceptions.

Example usage
-------------

```python
    from src.suppliers.suppliers_list.aliexpress_com.api.skd.api.base import RestApi

    # Example of creating a RestApi instance
    # api = RestApi(domain="api-sg.apiexpress.com")
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/api/skd/api/base.py
"""
'''
Created on 2012-7-3
...
def sign(secret, parameters):
    ...
    # @param parameters: Supports dictionary and string types
    # '''
    # ===========================================================================
    # If parameters is a dictionary
...
class RequestException(Exception):
    # ===========================================================================
    # Request connection exception class
    # ===========================================================================
    pass
...
class RestApi(object):
    ...
    def __init__(self, domain="api-sg.apiexpress.com", port=80):
        ...
        # Args @param domain: Request domain or IP
    ...
    def getApplicationParameters(self):
        ...
        # Query translation dictionary to avoid some keyword properties
