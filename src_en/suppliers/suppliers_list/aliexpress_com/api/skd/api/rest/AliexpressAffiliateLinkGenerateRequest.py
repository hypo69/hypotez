## \file /src/suppliers/suppliers_list/aliexpress_com/api/skd/api/rest/AliexpressAffiliateLinkGenerateRequest.py
# -*- coding: utf-8 -*-
 # <- venv win
"""
.. module:: src.suppliers.suppliers_list.aliexpress_com.api.skd.api.rest.AliexpressAffiliateLinkGenerateRequest
...
```python
    from src.suppliers.suppliers_list.aliexpress_com.api.skd.api.rest import AliexpressAffiliateLinkGenerateRequest
...
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/api/skd/api/rest/AliexpressAffiliateLinkGenerateRequest.py
"""
"""
