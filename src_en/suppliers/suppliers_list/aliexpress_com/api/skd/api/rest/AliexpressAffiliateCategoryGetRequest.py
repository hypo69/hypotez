## \file /src/suppliers/suppliers_list/aliexpress_com/api/skd/api/rest/AliexpressAffiliateCategoryGetRequest.py
# -*- coding: utf-8 -*-
 # <- venv win
"""
.. module:: src.suppliers.suppliers_list.aliexpress_com.api.skd.api.rest.AliexpressAffiliateCategoryGetRequest
...
```python
    from src.suppliers.suppliers_list.aliexpress_com.api.skd.api.rest import AliexpressAffiliateCategoryGetRequest
...
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/api/skd/api/rest/AliexpressAffiliateCategoryGetRequest.py
"""
"""
