## \file /src/suppliers/suppliers_list/aliexpress_com/api/api.py
# -*- coding: utf-8 -*-
 # <- venv win
"""
.. module:: src.suppliers.suppliers_list.aliexpress_com.api.api
    :platform: Windows, Unix
    :synopsis: AliExpress API wrapper for Python.

This module provides a simple Python wrapper for the AliExpress Open Platform API.
It allows retrieving product information and affiliate links from AliExpress
using the official API in an easier way.
...
```python
    ...
    async def main():
        api = AliexpressApi(key="YOUR_API_KEY", secret="YOUR_SECRET", language="en", currency="USD", tracking_id="YOUR_TRACKING_ID")
        # Example: Get product details
        # products = api.retrieve_product_details(product_ids=["1005001234567890"])
        # print(products)

        # Example: Get affiliate links
        # affiliate_links = api.get_affiliate_links(links=["https://www.aliexpress.com/item/1005001234567890.html"])
...
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/api/api.py
"""
