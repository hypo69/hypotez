## \file /src/suppliers/suppliers_list/aliexpress_com/api/_examples/iop/base.py
# -*- coding: utf-8 -*-
 # <- venv win
"""
.. module:: src.suppliers.suppliers_list.aliexpress_com.api._examples.iop.base
    :platform: Windows, Unix
    :synopsis: Base classes for AliExpress IOP API examples.

This module provides base classes and functions for interacting with the AliExpress
IOP (International Open Platform) API. It includes utilities for signing requests,
logging errors, and handling API responses.

Example usage
-------------

```python
    from src.suppliers.suppliers_list.aliexpress_com.api._examples.iop.base import IopClient, IopRequest

    # Example of creating an API client and making a request
    # client = IopClient("https://api.example.com/rest", "app_key", "app_secret")
    # request = IopRequest("some.api.method")
...
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/api/_examples/iop/base.py
"""
