## \file /src/suppliers/suppliers_list/aliexpress_com/alirequests.py
# -*- coding: utf-8 -*-

#! .pyenv/bin/python3

"""
.. module:: src.suppliers.suppliers_list.aliexpress_com.alirequests
    :platform: Windows, Unix
    :synopsis: Module for handling requests to AliExpress.

This module provides the `AliRequests` class, which handles HTTP requests to AliExpress
and manages cookies and headers for these requests.
...
```python
    ...
    requests_handler = AliRequests()
    response = requests_handler.make_get_request("https://www.aliexpress.com/item/1005001234567890.html")
    if response:
...
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/alirequests.py
"""
