## \file /src/suppliers/suppliers_list/aliexpress_com/affiliated_products_generator.py
# -*- coding: utf-8 -*-

#! .pyenv/bin/python3

"""
.. module:: src.suppliers.suppliers_list.aliexpress_com.affiliated_products_generator
...
```python
    ...
    async def main():
        ...
        category_root = Path("output/my_campaign")
        processed_products = await generator.process_affiliate_products(prod_ids, category_root)
...
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/affiliated_products_generator.py
"""
...
class AliAffiliatedProducts(AliApi):
    ...
    async def process_affiliate_products(self, prod_ids: list[str], category_root: Path | str) -> list[SimpleNamespace]:
        ...
        _prod_urls: list = []
        normilized_prod_urls = ensure_https(prod_ids) # <- normalize to `https://aliexpress_com.com/item/<product_id>.html`
        print_flag = '' # <- flag to switch single-line printing
