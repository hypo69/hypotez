## \file /src/suppliers/suppliers_list/aliexpress_com/aliapi.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
.. module:: src.suppliers.suppliers_list.aliexpress_com.aliapi
    :platform: Windows, Unix
    :synopsis: Custom API class for AliExpress operations.

This module provides a custom API class for interacting with AliExpress,
including retrieving product details and generating affiliate links.
...
```python
    ...
    async def main():
        ...
        # Example product IDs
        product_ids = ["1005001234567890", "1005009876543210"]
...
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/aliapi.py
"""
