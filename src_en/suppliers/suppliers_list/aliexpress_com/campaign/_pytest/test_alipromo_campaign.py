## \file /src/suppliers/suppliers_list/aliexpress_com/campaign/_pytest/test_alipromo_campaign.py
# -*- coding: utf-8 -*-
...
.. module:: src.suppliers.suppliers_list.aliexpress_com.campaign._pytest
    ...
    :synopsis: Pytest for AliExpress promotional campaign.

This module contains pytest tests for the AliExpress promotional campaign functionality,
covering initialization, product retrieval, and data saving.
...
```python
    ...
    # pytest src/suppliers/suppliers_list/aliexpress_com/campaign/_pytest/test_alipromo_campaign.py
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/campaign/_pytest/test_alipromo_campaign.py
"""
