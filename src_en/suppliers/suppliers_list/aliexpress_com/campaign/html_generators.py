## \file /src/suppliers/suppliers_list/aliexpress_com/campaign/html_generators.py
# -*- coding: utf-8 -*-

#! .pyenv/bin/python3

"""
.. module:: src.suppliers.suppliers_list.aliexpress_com.campaign.html_generators
    :platform: Windows, Unix
    :synopsis: HTML content generator for advertising campaigns.

This module provides classes for generating HTML content for individual products,
product categories, and overall campaigns, including links to Bootstrap CSS and custom styles.

Example usage
-------------

```python
    from src.suppliers.suppliers_list.aliexpress_com.campaign.html_generators import ProductHTMLGenerator
    ...
    #     local_image_path="./images/test.png",
    #     target_sale_price="10.00",
    #     target_sale_price_currency="USD",
    #     target_original_price="15.00",
    #     target_original_price_currency="USD",
    #     second_level_category_name="Electronics",
    #     promotion_link="https://example.com/product/123"
    # )
    # ProductHTMLGenerator.set_product_html(product, Path("output/category_name"))
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/campaign/html_generators.py
"""
