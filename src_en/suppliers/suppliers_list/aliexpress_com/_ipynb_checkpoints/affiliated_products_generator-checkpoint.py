## \file /src/suppliers/suppliers_list/aliexpress_com/_ipynb_checkpoints/affiliated_products_generator-checkpoint.py
# -*- coding: utf-8 -*-

#! .pyenv/bin/python3

"""
.. module:: src.suppliers.aliexpress_com._ipynb_checkpoints.affiliated_products_generator
    :platform: Windows, Unix
    :synopsis: Module for generating affiliated products for AliExpress.

This module provides a class `AliAffiliatedProducts` for collecting full product data
from URLs or product IDs on AliExpress, generating affiliate links, saving images,
and creating various output formats for ad campaigns.
...
```python
    import asyncio
    from src.suppliers.aliexpress_com.affiliated_products_generator import AliAffiliatedProducts
    from pathlib import Path

    async def main():
        generator = AliAffiliatedProducts()
        # Example product IDs or URLs
        prod_ids = ["1005001234567890", "https://www.aliexpress.com/item/1005009876543210.html"]
        category_path = Path("output/my_campaign")
        processed_products = generator.process_affiliate_products(prod_ids, category_path, "en")
...
:version: 1.0.0
:location: src/suppliers/suppliers_list/aliexpress_com/_ipynb_checkpoints/affiliated_products_generator-checkpoint.py
"""

""" The class creates products with 'promotion_link' for the product"""


import header   # <- used when running the module via main(). Contains setting the root of modules to `src`
import asyncio
...
from src import gs
from src.suppliers.aliexpress.api.api import AliApi
from src.suppliers.aliexpress.aliexpress import Aliexpress
from src.suppliers.aliexpress.affiliate_links_shortener_scenario import AffiliateLinksShortener
from src.suppliers.aliexpress_com.utils.extract_product_id import extract_prod_ids
from src.suppliers.aliexpress_com.utils.ensure_https import ensure_https
from src.utils import StringNormalizer as SN
from src.utils.convertors.csv import csv2dict
from src.utils.jjson import j_dumps, j_loads, j_loads_ns
from src.utils.image import save_image_from_url, save_video_from_url, save_text_file, pprint
