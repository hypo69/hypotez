...
""".. Module :: src.suppliers.ksp 
	...
	: synopsis: the class collects the value of the fields on the product page `ksp.co.il`. 
...
class Graber(GraberBase):
    ...
    def __init__(self, driver: Optional['Driver'] = None, lang_index:Optional[int] = None):
        ...
        time.sleep(3)
        if '/mob/' in self.driver.current_url: # <- Former that connects to the mobile version of the site
