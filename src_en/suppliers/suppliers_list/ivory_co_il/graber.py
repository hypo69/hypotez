...
""".. Module :: src.suppliers.ivory 
	...
	: synopsis: the class collects the value of the fields on the product page `iVory.co.il`. 
...
class Graber(GraberBase):
    ...
    def __init__(self, driver:  = None, lang_index:Optional[int] = None):
        ...
        Config.locator_for_decorator = None # < - If the value is set, then it will be completed in the decorator `@close_pop_up`
