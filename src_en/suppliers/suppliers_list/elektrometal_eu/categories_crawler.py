# # \file /src/suppliers/suppliers_list/elektrometal_eu/categories_crawler.py
# -*- coding: utf-8 -*-
# ! .pyenv/bin/python3
""".. module:: src.suppliers.suppliers_list.elektrometal_eu.categories_crawler
    :platform: Windows, Unix
    :synopsis: Module for collecting products from Elektrometal (EU) category pages via webdriver.

Elektrometal (EU) Category Page Product Scraper
=========================================================================================

This module is responsible for scraping product data from Elektrometal (EU) category pages using a webdriver.
...
- The module collects a list of categories from the seller's pages (`get_list_categories_from_site()`).
  ...
  Essentially, a table of `PrestaShop.categories <-> elektrometal.shop.categories` should be maintained.
...
:version: 1.0.0
:location: suppliers/suppliers_list/elektrometal_eu/categories_crawler.py"""
