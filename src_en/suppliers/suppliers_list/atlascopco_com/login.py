## \file /src/suppliers/suppliers_list/atlascopco_com/login.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.atlascopco_com.login
    :platform: Windows, Unix
    :synopsis: Webdriver-based login interface for Atlas Copco.

Atlas Copco Login Interface
=========================================================================================

This module provides a login interface for Atlas Copco using a webdriver.
...
```python
    ...
    from src.suppliers.suppliers_list.atlascopco_com.login import login
    ...
    class DummySupplier:
        def __init__(self, driver):
            ...
            self.locators_store = {
                'login': {
                    'open_login_inputs': {'by': 'id', 'value': 'login-button'}, # Placeholder, replace with actual Atlas Copco login locator
    ...
    if login(supplier_instance):
        print("Successfully logged in to Atlas Copco.")
    else:
        print("Failed to log in to Atlas Copco.")
...
:version: 1.0.0
:location: suppliers/suppliers_list/atlascopco_com/login.py
"""