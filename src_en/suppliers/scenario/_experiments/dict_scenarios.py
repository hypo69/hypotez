## \file /src/suppliers/scenario/_experiments/dict_scenarios.py
# -*- coding: utf-8 -*-
...
.. module:: src.suppliers.scenario._experiments
    ...
    :synopsis: Dictionary of example scenarios.

This module contains a dictionary of example scenarios for various suppliers.

Example usage
-------------

```python
    from src.suppliers.scenario._experiments.dict_scenarios import scenario

    # Access a specific scenario
    apple_watches_scenario = scenario["Apple Wathes"]
    print(apple_watches_scenario["url"])
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/suppliers/scenario/_experiments/dict_scenarios.py
"""
