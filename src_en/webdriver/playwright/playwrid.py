...
if __name__ == "__main__":
    async def main():
        ...
        # Obtaining HTML the entire document
        html_content = browser.get_page_content()
        if html_content:
            print(html_content[:200])  # We will display the first 200 characters for example
        else:
            print("Не удалось получить HTML-контент.")
        
        # Getting an HTML element by selector
        ...
        # Obtaining the element value according to Xpath
