...
class Tab:
    ...
    async def find(
        ...
        el: List['WebElement'] = await self.find_or_wait_element(
                                                                ...
                                                                timeout = timeout_to_use, # <- This is important! This is an asynchronous expectation timout.
                                                                # In the debuger, I made it big, but in the walk this will lead to freezing when searching
                                                                find_all=True,
                                                                raise_exc=raise_exc
                                                            )
        return el
