## \file src/webdriver/pydoll/llib/connection/managers/events_manager.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a manager for handling events.
==================================================

This module contains the `EventsManager` class, which is responsible for
managing event callbacks, processing events, and maintaining network logs.
...
```python
    ...
    events_manager.register_callback("Page.loadEventFired", my_callback)
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/connection/managers/events_manager.py
"""
...
from src.webdriver.pydoll.llib.protocol.base import Event
