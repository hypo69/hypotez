## \file src/webdriver/pydoll/llib/utils.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides utility functions for the Pydoll library.
=============================================================

This module contains various utility functions used throughout the Pydoll library,
including HTML parsing, base64 encoding/decoding, browser path validation,
and JavaScript script analysis.

Example usage
-------------

```python
    from src.webdriver.pydoll.llib.utils import extract_text_from_html
...
:version: 1.0.0
:location: src/webdriver/pydoll/llib/utils.py
"""
...
from src.webdriver.pydoll.llib.exceptions import InvalidBrowserPath, InvalidResponse, NetworkError
