## \file src/webdriver/pydoll/llib/protocol/network/params.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module defines parameter structures for network operations in the Chrome DevTools Protocol.
============================================================================================

This module contains `TypedDict` definitions for the parameters used in various
network-related commands in the Chrome DevTools Protocol, such as deleting cookies,
emulating network conditions, and setting extra HTTP headers.

Example usage
-------------

```python
    from src.webdriver.pydoll.llib.protocol.network.params import SetCookieParams

    # Example of creating SetCookieParams
    params = SetCookieParams(name="my_cookie", value="my_value", domain=".example.com")
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/protocol/network/params.py
"""
...
from src.webdriver.pydoll.llib.protocol.fetch.types import HeaderEntry, RequestPattern
