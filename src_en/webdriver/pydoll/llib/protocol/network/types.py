## \file src/webdriver/pydoll/llib/protocol/network/types.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module defines types related to network operations in the Chrome DevTools Protocol.
=====================================================================================

This module contains `TypedDict` definitions for various network-related types,
such as `SearchMatch`, `Cookie`, `SecurityIsolationStatus`, and `NetworkLog`.
These types are used to represent information about network requests, responses,
cookies, and security details.

Example usage
-------------

```python
    from src.webdriver.pydoll.llib.protocol.network.types import Cookie, Request
...
:version: 1.0.0
:location: src/webdriver/pydoll/llib/protocol/network/types.py
"""
...
from src.webdriver.pydoll.llib.protocol.runtime.types import StackTrace
