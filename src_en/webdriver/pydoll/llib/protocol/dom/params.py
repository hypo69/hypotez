## \file src/webdriver/pydoll/llib/protocol/dom/params.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module defines parameter structures for DOM operations in the Chrome DevTools Protocol.
========================================================================================

This module contains `TypedDict` definitions for the parameters used in various
DOM-related commands in the Chrome DevTools Protocol, such as describing nodes,
getting attributes, and querying elements.

Example usage
-------------

```python
    from src.webdriver.pydoll.llib.protocol.dom.params import QuerySelectorParams

    # Example of creating QuerySelectorParams
    params = QuerySelectorParams(nodeId=1, selector="#my-element")
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/protocol/dom/params.py
"""
...
from src.webdriver.pydoll.llib.protocol.dom.types import (
