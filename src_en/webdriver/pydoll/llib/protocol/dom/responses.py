## \file src/webdriver/pydoll/llib/protocol/dom/responses.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module defines response structures for DOM operations in the Chrome DevTools Protocol.
=======================================================================================
...
```python
    ...
    # Example of a DescribeNodeResponse object
...
:version: 1.0.0
:location: src/webdriver/pydoll/llib/protocol/dom/responses.py
"""
...
from src.webdriver.pydoll.llib.protocol.runtime.types import RemoteObject, StackTrace
