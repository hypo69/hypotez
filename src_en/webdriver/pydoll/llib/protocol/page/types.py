## \file src/webdriver/pydoll/llib/protocol/page/types.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module defines types related to page operations in the Chrome DevTools Protocol.
==================================================================================

This module contains `TypedDict` definitions for various page-related types,
such as `Viewport`, `InstallabilityError`, `FontFamilies`, and `Frame`.
These types are used to represent information about the page's layout, fonts,
manifest, and frame structure.
...
```python
    ...
    viewport: Viewport = {"x": 0, "y": 0, "width": 1920, "height": 1080, "scale": 1.0}
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/protocol/page/types.py
"""
