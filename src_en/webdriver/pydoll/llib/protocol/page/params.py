## \file src/webdriver/pydoll/llib/protocol/page/params.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module defines parameter structures for page operations in the Chrome DevTools Protocol.
==========================================================================================

This module contains `TypedDict` definitions for the parameters used in various
page-related commands in the Chrome DevTools Protocol, such as adding scripts to
new documents, capturing screenshots, and handling JavaScript dialogs.

Example usage
-------------

```python
    from src.webdriver.pydoll.llib.protocol.page.params import NavigateParams

    # Example of creating NavigateParams
    params = NavigateParams(url="https://www.google.com")
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/protocol/page/params.py
"""
