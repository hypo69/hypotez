## \file src/webdriver/pydoll/llib/protocol/page/responses.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module defines response structures for page operations in the Chrome DevTools Protocol.
=========================================================================================

This module contains `TypedDict` definitions for the responses returned by various
page-related commands in the Chrome DevTools Protocol, such as capturing screenshots,
getting app manifests, and retrieving navigation history.
...
```python
    ...
    # Example of a CaptureScreenshotResponse object
    response: CaptureScreenshotResponse = {"result": {"data": "base64_encoded_image_data"}}
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/protocol/page/responses.py
"""

from typing_extensions import NotRequired, TypedDict

from src.webdriver.pydoll.llib.protocol.dom.types import Rect
from src.webdriver.pydoll.llib.protocol.network.types import SearchMatch
from src.webdriver.pydoll.llib.protocol.page.types import (
    AdScriptId,
    AppManifestError,
    FrameResourceTree,
    FrameTree,
