## \file src/webdriver/pydoll/llib/commands/target_commands.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a class for creating Target commands for the Chrome DevTools Protocol.
=======================================================================================

This module contains the `TargetCommands` class, which provides static methods for
creating Target commands for the Chrome DevTools Protocol. These commands allow you to
interact with browser targets, such as creating, activating, attaching to, and closing
targets.
...
```python
    ...
    # Create a command to create a new target
    create_target_command = TargetCommands.create_target(url="https://www.google.com")

    # Create a command to close a target
    close_target_command = TargetCommands.close_target(target_id="some_target_id")
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/commands/target_commands.py
"""
...
from src.webdriver.pydoll.llib.protocol.target.methods import TargetMethod
from src.webdriver.pydoll.llib.protocol.target.params import (
