## \file src/webdriver/pydoll/llib/commands/dom_commands.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a class for creating DOM commands for the Chrome DevTools Protocol.
====================================================================================

This module contains the `DomCommands` class, which provides static methods for
creating DOM commands for the Chrome DevTools Protocol. These commands allow you to
interact with the Document Object Model (DOM) of a web page, such as getting
information about nodes, manipulating the DOM tree, and searching for elements.
...
```python
    ...
    # Create a command to get the document root
    get_document_command = DomCommands.get_document()

    # Create a command to query for an element
    query_selector_command = DomCommands.query_selector(node_id=1, selector="#my-element")
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/commands/dom_commands.py
"""

from typing import Optional

from src.webdriver.pydoll.llib.constants import ElementRelation, IncludeWhitespace, LogicalAxes, PhysicalAxes
from src.webdriver.pydoll.llib.protocol.base import Command, Response
from src.webdriver.pydoll.llib.protocol.dom.methods import DomMethod
from src.webdriver.pydoll.llib.protocol.dom.params import (
