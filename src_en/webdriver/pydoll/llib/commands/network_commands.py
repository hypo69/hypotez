## \file src/webdriver/pydoll/llib/commands/network_commands.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a class for creating Network commands for the Chrome DevTools Protocol.
========================================================================================

This module contains the `NetworkCommands` class, which provides static methods for
creating Network commands for the Chrome DevTools Protocol. These commands allow you to
interact with the network, such as clearing the browser cache, deleting cookies,
and enabling network tracking.
...
```python
    ...
    # Create a command to clear the browser cache
    clear_cache_command = NetworkCommands.clear_browser_cache()

    # Create a command to enable network tracking
    enable_network_command = NetworkCommands.enable()
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/commands/network_commands.py
"""
...
from src.webdriver.pydoll.llib.protocol.network.methods import NetworkMethod
from src.webdriver.pydoll.llib.protocol.network.params import (
    DeleteCookiesParams,
...
from src.webdriver.pydoll.llib.protocol.network.responses import (
...
from src.webdriver.pydoll.llib.protocol.network.types import (
    CookiePartitionKey,
