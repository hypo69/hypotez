## \file src/webdriver/pydoll/llib/commands/input_commands.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a class for creating Input commands for the Chrome DevTools Protocol.
======================================================================================

This module contains the `InputCommands` class, which provides static methods for
creating Input commands for the Chrome DevTools Protocol. These commands allow you to
simulate user input, such as keyboard events, mouse events, and touch events.
...
```python
    ...
    # Create a command to dispatch a key event
    key_event_command = InputCommands.dispatch_key_event(type=KeyEventType.KEY_DOWN, key="a")
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/commands/input_commands.py
"""
...
from src.webdriver.pydoll.llib.protocol.input.methods import InputMethod
from src.webdriver.pydoll.llib.protocol.input.params import (
