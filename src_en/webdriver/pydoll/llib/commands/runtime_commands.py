## \file src/webdriver/pydoll/llib/commands/runtime_commands.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a class for creating Runtime commands for the Chrome DevTools Protocol.
========================================================================================

This module contains the `RuntimeCommands` class, which provides static methods for
creating Runtime commands for the Chrome DevTools Protocol. These commands allow you to
interact with the JavaScript runtime, such as evaluating expressions, calling functions,
...
```python
    ...
    # Create a command to evaluate a JavaScript expression
    evaluate_command = RuntimeCommands.evaluate(expression="1 + 1")

    # Create a command to get the properties of an object
    get_properties_command = RuntimeCommands.get_properties(object_id="some_object_id")
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/commands/runtime_commands.py
"""

from typing import Optional

from src.webdriver.pydoll.llib.protocol.base import Command, Response
from src.webdriver.pydoll.llib.protocol.runtime.methods import RuntimeMethod
from src.webdriver.pydoll.llib.protocol.runtime.params import (
    AddBindingParams,
    AwaitPromiseParams,
    CallArgument,
