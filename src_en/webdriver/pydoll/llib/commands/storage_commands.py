## \file src/webdriver/pydoll/llib/commands/storage_commands.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a class for creating Storage commands for the Chrome DevTools Protocol.
========================================================================================

This module contains the `StorageCommands` class, which provides static methods for
creating Storage commands for the Chrome DevTools Protocol. These commands allow you to
interact with various types of browser storage, such as cookies, local storage,
and IndexedDB.
...
```python
    ...
    # Create a command to clear all cookies
    clear_cookies_command = StorageCommands.clear_cookies()

    # Create a command to get all cookies
    get_cookies_command = StorageCommands.get_cookies()
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/commands/storage_commands.py
"""

from typing import Optional

from src.webdriver.pydoll.llib.protocol.base import Command, Response
from src.webdriver.pydoll.llib.protocol.network.types import CookieParam
from src.webdriver.pydoll.llib.protocol.storage.methods import StorageMethod
from src.webdriver.pydoll.llib.protocol.storage.params import (
    ClearCookiesParams,
...
from src.webdriver.pydoll.llib.protocol.storage.responses import (
