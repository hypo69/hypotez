## \file src/webdriver/pydoll/llib/commands/browser_commands.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a class for creating Browser commands for the Chrome DevTools Protocol.
========================================================================================

This module contains the `BrowserCommands` class, which provides static methods for
creating Browser commands for the Chrome DevTools Protocol. These commands allow you to
interact with the browser, such as getting the browser version, setting download
behavior, and managing browser windows.
...
```python
    ...
    # Create a command to get the browser version
    get_version_command = BrowserCommands.get_version()

    # Create a command to close the browser
    close_command = BrowserCommands.close()
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/commands/browser_commands.py
"""
...
from src.webdriver.pydoll.llib.protocol.browser.methods import BrowserMethod
from src.webdriver.pydoll.llib.protocol.browser.params import (
