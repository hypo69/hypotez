## \file src/webdriver/pydoll/llib/commands/page_commands.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a class for creating Page commands for the Chrome DevTools Protocol.
======================================================================================

This module contains the `PageCommands` class, which provides static methods for
creating Page commands for the Chrome DevTools Protocol. These commands allow you to
interact with a web page, such as navigating to a URL, capturing a screenshot,
and handling JavaScript dialogs.
...
```python
    ...
    # Create a command to capture a screenshot
    screenshot_command = PageCommands.capture_screenshot()
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/commands/page_commands.py
"""
...
from src.webdriver.pydoll.llib.protocol.page.methods import PageMethod
from src.webdriver.pydoll.llib.protocol.page.params import (
...
from src.webdriver.pydoll.llib.protocol.page.responses import (
