## \file src/webdriver/pydoll/llib/browser/tab.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
...
===============================================================
This module provides the Tab class, which is a wrapper around the base Tab
from pydoll.browser.tab and adds the execute_locator method for working with locators.
It supports asynchronous operations, waiting for events, and extracting data from elements.

```rst
.. module:: src.webdriver.pydoll.llib.browser.tab
```
"""
...
from src.webdriver.pydoll.llib.protocol.base import Response
from src.webdriver.pydoll.llib.protocol.dom.types import EventFileChooserOpened
from src.webdriver.pydoll.llib.protocol.fetch.types import HeaderEntry
from src.webdriver.pydoll.llib.protocol.network.responses import GetResponseBodyResponse
from src.webdriver.pydoll.llib.protocol.network.types import Cookie, CookieParam, NetworkLog
from src.webdriver.pydoll.llib.protocol.page.events import PageEvent
from src.webdriver.pydoll.llib.protocol.page.responses import CaptureScreenshotResponse, PrintToPDFResponse
from src.webdriver.pydoll.llib.protocol.runtime.responses import CallFunctionOnResponse, EvaluateResponse
