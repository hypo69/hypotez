## \file src/webdriver/pydoll/llib/browser/managers/proxy_manager.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a manager for proxy settings.
=================================================

This module contains the `ProxyManager` class, which is responsible for
managing the proxy settings for the browser.
...
```python
    ...
    proxy_manager = ProxyManager(options)
    has_proxy, credentials = proxy_manager.get_proxy_credentials()
```

:author: hypo69
:license: Proprietary. All rights reserved.
:version: 1.0.0
:location: src/webdriver/pydoll/llib/browser/managers/proxy_manager.py
"""

from typing import Optional
from header import __root__
from src.webdriver.pydoll.llib.browser.options import Options
