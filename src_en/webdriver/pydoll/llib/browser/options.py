## \file src/webdriver/pydoll/llib/browser/options.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a class for managing browser options.
========================================================

This module contains the `ChromiumOptions` class, which allows you to configure various
options for a Chromium-based browser, such as command-line arguments, binary location,
...
:version: 1.0.0
:location: src/webdriver/pydoll/llib/browser/options.py
"""

from contextlib import suppress
from header import __root__
from src.webdriver.pydoll.llib.browser.interfaces import Options
from src.webdriver.pydoll.llib.exceptions import ArgumentAlreadyExistsInOptions, WrongPrefsDict
