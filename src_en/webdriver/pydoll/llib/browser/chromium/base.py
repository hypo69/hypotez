## \file src/webdriver/pydoll/llib/browser/chromium/base.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3

"""
This module provides a base class for automating Chromium-based browsers.
==========================================================================

This module contains the `Browser` class, which is an abstract base class for automating
Chromium-based browsers using the Chrome DevTools Protocol. It provides a high-level
API for controlling the browser, including launching and stopping the browser,
managing browser contexts, and working with tabs.
...
:version: 1.0.0
:location: src/webdriver/pydoll/llib/browser/chromium/base.py
"""
...
from src.webdriver.pydoll.llib.browser.managers import (
    BrowserProcessManager,
    ProxyManager,
    TempDirectoryManager,
)
from src.webdriver.pydoll.llib.browser.tab import Tab
...
from src.webdriver.pydoll.llib.exceptions import BrowserNotRunning, FailedToStartBrowser, NoValidTabFound
from src.webdriver.pydoll.llib.protocol.base import Command, Response
from src.webdriver.pydoll.llib.protocol.browser.responses import (
    GetVersionResponse,
    GetVersionResultDict,
    GetWindowForTargetResponse,
)
from src.webdriver.pydoll.llib.protocol.browser.types import WindowBoundsDict
from src.webdriver.pydoll.llib.protocol.fetch.events import FetchEvent
from src.webdriver.pydoll.llib.protocol.fetch.types import HeaderEntry
from src.webdriver.pydoll.llib.protocol.network.types import Cookie, CookieParam, RequestPausedEvent
from src.webdriver.pydoll.llib.protocol.storage.responses import GetCookiesResponse
from src.webdriver.pydoll.llib.protocol.target.responses import (
    CreateBrowserContextResponse,
    CreateTargetResponse,
    GetBrowserContextsResponse,
    GetTargetsResponse,
)
from src.webdriver.pydoll.llib.protocol.target.types import TargetInfo
...
class Browser(ABC):  # noqa: PLR0904
    ...
    async def start(self, headless: bool = False) -> Tab:
        ...
        self.process = self._browser_process_manager.start_browser_process(
