...
"""This module is a key component for automated interaction with web pages. 
               It allows you to find elements on the page on various locators (for example, ID, Class, Xpath), 
               perform various actions with them (for example, click, input of the text) and receive the values of their attributes. 
               The module also includes mechanisms for the appearance of elements and processing possible errors, such as timeouts and click interceptions.

Module documentation: https://github.com/hypo69/hypotez/blob/master/docs/ru/src/webdriver/executor.py.md
Locators https://github.com/hypo69/hypotez/blob/master/docs/ru/src/webdriver/locator.md
`` `RST
...
class ExecuteLocator:
    ...
    async def execute_locator(
        ...
        if not getattr(locator, "attribute", None) and not getattr(locator, "selector", None):
            logger.debug("Empty locator provided.", None, False) # <- a plug
            return None
