...
git 👉 https://github.com/googleapis/google-api-python-client/blob/main/samples/searchforshopping/main.py
"""
...
def main():
    p = build('search','v1',developerKey="AIzaSyATzEjS5-C-YguhlyReXgEQmQy5U3vnXmM")
    #p = build("shopping", "v1", developerKey="AIzaSyATzEjS5-C-YguhlyReXgEQmQy5U3vnXmM")
