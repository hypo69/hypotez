...
2.  Определяет расширения Sphinx, Используетсяые для генерации документации, такие как `sphinx.ext.autodoc` для автоматического создания документации из docstring'ов.
