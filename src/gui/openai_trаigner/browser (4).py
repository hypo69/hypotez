## \file /src/gui/openai_trаigner/browser (4).py
# -*- coding: utf-8 -*-
...
class FramelessWindow(QMainWindow):
    def __init__(self):
        ...
        google_login_action.triggered.connect(lambda: self.load_url("https://accounts.google.com"))  # URL для Google Login

        model_menu.addAction(chatgpt_action)
        model_menu.addAction(gemini_action)
        model_menu.addAction(claude_action)
        model_menu.addAction(google_login_action)
