...
from src.webdriver.pydoll.llib.pydoll.protocol.dom.responses import (
    GetBoxModelResponse,
    GetOuterHTMLResponse,
)
from src.webdriver.pydoll.llib.pydoll.protocol.dom.types import Quad
from src.webdriver.pydoll.llib.pydoll.protocol.page.responses import CaptureScreenshotResponse
from src.webdriver.pydoll.llib.pydoll.protocol.page.types import Viewport
