...
from src.webdriver.pydoll.llib.pydoll.constants import By, RequestStage, ResourceType, RequestMethod
...
class TestTabRequestManagement:
    ...
    async def test_fail_request(self, tab):
        ...
        from src.webdriver.pydoll.llib.pydoll.constants import NetworkErrorReason
    ...
    async def test_continue_request_with_all_params(self, tab):
        ...
        from src.webdriver.pydoll.llib.pydoll.constants import RequestMethod
