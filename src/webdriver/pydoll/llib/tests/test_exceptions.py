...
class TestExceptionInheritance:
    ...
    def test_all_exceptions_inherit_from_pydoll_exception(self):
        """Test that all custom exceptions inherit from src.webdriver.pydoll.llib.pydollException."""
        exceptions_to_test = [
        ...
        for exception_class in exceptions_to_test:
            assert issubclass(exception_class, PydollException), f"{exception_class.__name__} should inherit from src.webdriver.pydoll.llib.pydollException"

    def test_base_exception_categories(self):
        """Test that base exception categories inherit from src.webdriver.pydoll.llib.pydollException."""
        base_exceptions = [
