## \file /src/suppliers/suppliers_list/generex_de/_experiments/notebook_header.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.generex_de._experiments.notebook_header
    :platform: Windows, Unix
    :synopsis: Header for Jupyter notebooks related to Generex (Germany) supplier experiments.

Generex (Germany) Notebook Header
=========================================================================================
...
```python
    ...
    # import src.suppliers.suppliers_list.generex_de._experiments.notebook_header
    # from src.suppliers.suppliers_list.generex_de._experiments.notebook_header import start_supplier
...
:version: 1.0.0
:location: suppliers/suppliers_list/generex_de/_experiments/notebook_header.py
"""
