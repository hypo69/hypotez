## \file /src/suppliers/suppliers_list/dewesoft_com/categories_crawler.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.dewesoft_com.categories_crawler
    :platform: Windows, Unix
    :synopsis: Module for collecting products from Dewesoft category pages via webdriver.

Dewesoft Category Page Product Scraper
=========================================================================================

This module is responsible for scraping product data from Dewesoft category pages using a webdriver.
...
- The module collects a list of categories from the seller's pages (`get_list_categories_from_site()`).
  ...
  Essentially, a table of `PrestaShop.categories <-> dewesoft.shop.categories` should be maintained.
...
:version: 1.0.0
:location: suppliers/suppliers_list/dewesoft_com/categories_crawler.py
"""
