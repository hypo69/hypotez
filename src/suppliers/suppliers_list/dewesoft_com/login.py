## \file /src/suppliers/suppliers_list/dewesoft_com/login.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.dewesoft_com.login
    :platform: Windows, Unix
    :synopsis: Webdriver-based login interface for Dewesoft.

Dewesoft Login Interface
=========================================================================================

This module provides a login interface for Dewesoft using a webdriver.
...
```python
    ...
    from src.suppliers.suppliers_list.dewesoft_com.login import login
    ...
    if login(supplier_instance):
        print("Successfully logged in to Dewesoft.")
    else:
        print("Failed to log in to Dewesoft.")
...
:version: 1.0.0
:location: suppliers/suppliers_list/dewesoft_com/login.py
"""