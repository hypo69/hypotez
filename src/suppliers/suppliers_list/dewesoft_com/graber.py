## \file /src/suppliers/suppliers_list/dewesoft_com/graber.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.dewesoft_com.graber
    :platform: Windows, Unix
    :synopsis: Module for collecting product data from Dewesoft.

Dewesoft Product Data Graber
=========================================================================================

This module provides a `Graber` class designed to extract product information from Dewesoft.
...
```python
    ...
    from src.suppliers.suppliers_list.dewesoft_com.graber import Graber
    ...
    # product_data = dewesoft_graber.grab_product_details("https://www.dewesoft.com/product/...")
    # print(product_data)
...
:version: 1.0.0
:location: suppliers/suppliers_list/dewesoft_com/graber.py
"""
...
class Graber(Grbr):
    """Class for Dewesoft grabbing operations."""
    supplier_prefix: str
