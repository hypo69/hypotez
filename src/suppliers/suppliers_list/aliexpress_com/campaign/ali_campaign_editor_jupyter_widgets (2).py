## \file /src/suppliers/aliexpress/campaign/ali_campaign_editor_jupyter_widgets (2).py
# -*- coding: utf-8 -*-
...
class JupyterCampaignEditorWidgets:
    ...
    def __init__(self):
        ...
        self.language_dropdown = widgets.Dropdown(
            options=[
                (f"{lang} {curr}", f"{lang} {curr}")
                for lang, curr in locales.items()
            ],
