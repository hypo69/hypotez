## \file /src/suppliers/aliexpress/campaign/prepare_campaigns (5).py
# -*- coding: utf-8 -*-
...
def process_campaign(
    ...
    if language is None or currency is None:
        ...
        locales_list = [(lang, curr) for locale in locales_data for lang, curr in locale.items()]
    else:
...
def process_all_campaigns(language: Optional[str] = None, currency: Optional[str] = None) -> None:
    ...
    if language is None or currency is None:
        # Process all locales if language or currency is not provided
        locales_to_process = [(lang, curr) for locale in locales_data for lang, curr in locale.items()]
    else:
