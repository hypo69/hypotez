## \file /src/suppliers/chat_gpt/conversations (11).py
# -*- coding: utf-8 -*-
...
class GPT_Traigner:
    ...
    def dump_downloaded_conversations(self):
        ...
        for local_file_path in html_files:
            ...
            user_elements:list = self.driver.execute_locator(locator.user)
            assistant_elements:list = self.driver.execute_locator(locator.assistant)
            
            user_content:list = [element.text for element in user_elements] if isinstance(user_elements, list) else [user_elements.text]
            assistant_content:list = [element.text for element in assistant_elements] if isinstance(assistant_elements, list) else [assistant_elements.text]
        ...
        if all_data:
            ...
            raw_conversations = ' '.join(all_data_df['content'].tolist())
