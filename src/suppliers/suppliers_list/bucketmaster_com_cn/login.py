## \file /src/suppliers/suppliers_list/bucketmaster_com_cn/login.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.bucketmaster_com_cn.login
    :platform: Windows, Unix
    :synopsis: Webdriver-based login interface for Bucketmaster (China).

Bucketmaster (China) Login Interface
=========================================================================================

This module provides a login interface for Bucketmaster (China) using a webdriver.
...
```python
    ...
    from src.suppliers.suppliers_list.bucketmaster_com_cn.login import login
    ...
    if login(supplier_instance):
        print("Successfully logged in to Bucketmaster (China).")
    else:
        print("Failed to log in to Bucketmaster (China).")
...
:version: 1.0.0
:location: suppliers/suppliers_list/bucketmaster_com_cn/login.py
"""