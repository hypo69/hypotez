## \file /src/suppliers/suppliers_list/de_de_ring_com/_experiments/notebook_header-Copy1.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.de_de_ring_com._experiments.notebook_header-Copy1
    :platform: Windows, Unix
    :synopsis: Header for Jupyter notebooks related to De-De-Ring supplier experiments (Copy 1).

De-De-Ring Notebook Header (Copy 1)
=========================================================================================
...
```python
    ...
    # import src.suppliers.suppliers_list.de_de_ring_com._experiments.notebook_header-Copy1
    # from src.suppliers.suppliers_list.de_de_ring_com._experiments.notebook_header-Copy1 import start_supplier
...
:version: 1.0.0
:location: suppliers/suppliers_list/de_de_ring_com/_experiments/notebook_header-Copy1.py
"""
