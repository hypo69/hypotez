## \file /src/suppliers/suppliers_list/fresubin_com/login.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.fresubin_com.login
    :platform: Windows, Unix
    :synopsis: Webdriver-based login interface for Fresubin.

Fresubin Login Interface
=========================================================================================

This module provides a login interface for Fresubin using a webdriver.
...
```python
    ...
    from src.suppliers.suppliers_list.fresubin_com.login import login
    ...
    if login(supplier_instance):
        print("Successfully logged in to Fresubin.")
    else:
        print("Failed to log in to Fresubin.")
...
:version: 1.0.0
:location: suppliers/suppliers_list/fresubin_com/login.py
"""
