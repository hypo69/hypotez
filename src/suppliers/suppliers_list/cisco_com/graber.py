## \file /src/suppliers/suppliers_list/cisco_com/graber.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.cisco_com.graber
    :platform: Windows, Unix
    :synopsis: Module for collecting product data from Cisco.

Cisco Product Data Graber
=========================================================================================

This module provides a `Graber` class designed to extract product information from Cisco.
...
```python
    ...
    from src.suppliers.suppliers_list.cisco_com.graber import Graber
...
:version: 1.0.0
:location: suppliers/suppliers_list/cisco_com/graber.py
"""
...
class Graber(GraberBase):
    """Class for Cisco grabbing operations."""
    supplier_prefix: str
