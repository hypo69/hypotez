## \file /src/suppliers/suppliers_list/gearbest_com/scenario.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.gearbest_com.scenario
    :platform: Windows, Unix
    :synopsis: Module for collecting products from Gearbest category pages via webdriver.

Gearbest Category Page Product Scraper
=========================================================================================

This module is responsible for scraping product data from Gearbest category pages using a webdriver.
...
- The module collects a list of categories from the seller's pages (`get_list_categories_from_site()`).
  ...
  Essentially, a table of `PrestaShop.categories <-> gearbest.shop.categories` should be maintained.
...
:version: 1.0.0
:location: suppliers/suppliers_list/gearbest_com/scenario.py
"""
