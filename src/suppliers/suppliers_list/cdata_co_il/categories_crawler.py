## \file /src/suppliers/suppliers_list/cdata_co_il/categories_crawler.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.cdata_co_il.categories_crawler
    :platform: Windows, Unix
    :synopsis: Module for collecting products from Cdata (Israel) category pages via webdriver.

Cdata (Israel) Category Page Product Scraper
=========================================================================================

This module is responsible for scraping product data from Cdata (Israel) category pages using a webdriver.
...
- The module collects a list of categories from the seller's pages (`get_list_categories_from_site()`).
  ...
  Essentially, a table of `PrestaShop.categories <-> cdata.shop.categories` should be maintained.
...
:version: 1.0.0
:location: suppliers/suppliers_list/cdata_co_il/categories_crawler.py
"""
...
def get_list_products_in_category (s) -> list[str, str, None]:    
    ...
    Returns:
        list or one of product URLs or None.
    """
    d = s.driver
