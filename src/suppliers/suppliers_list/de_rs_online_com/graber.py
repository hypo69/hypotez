## \file /src/suppliers/suppliers_list/de_rs_online_com/graber.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
"""
.. module:: src.suppliers.suppliers_list.de_rs_online_com.graber
    :platform: Windows, Unix
    :synopsis: Module for collecting product data from RS Online (Germany).

RS Online (Germany) Product Data Graber
=========================================================================================

This module provides a `Graber` class designed to extract product information from RS Online (Germany).
...
```python
    ...
    from src.suppliers.suppliers_list.de_rs_online_com.graber import Graber
...
:version: 1.0.0
:location: suppliers/suppliers_list/de_rs_online_com/graber.py
"""
...
class Graber(Grbr):
    ...
    def __init__(self, driver: Optional['Driver'] = None, lang_index:Optional[int] = None):
        ...
        """
        self.supplier_prefix = 'de_rs_online'
