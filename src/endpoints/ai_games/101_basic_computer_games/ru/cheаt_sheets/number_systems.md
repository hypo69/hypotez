...
*   **Основание (базис):** Это количество уникальных символов (цифр), которые мы Используется. Обозначим основание как `b`. Например, в десятичной системе основание равно 10.
*   **Цифры:** Это символы, которые мы Используется для записи чисел. Обычно это арабские цифры (0, 1, 2, 3, ...), но могут быть и другие символы, например, латинские буквы (I, V, X) или даже фрукты (🍎, 🍐, 🍉).
...
Системы счисления не только абстрактные математические понятия, но и реально Используетсяые способы кодирования информации. Вот несколько примеров:
