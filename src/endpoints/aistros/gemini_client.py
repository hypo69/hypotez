## \file src/endpoints/aistros/gemini_client.py
# -*- coding: utf-8 -*-
#! .pyenv/bin/python3
...
.. module:: src.endpoints.aistros.gemini_client
"""
...
class GeminiClient:
    ...
    def __init__(
        ...
        Example:
            ...
            >>> print(response)
        """
        # Загрузка конфигурации из aistros.json (находится в той же директории)
        aistros_config: SimpleNamespace = j_loads_ns(Path(__file__).parent / 'aistros.json')
