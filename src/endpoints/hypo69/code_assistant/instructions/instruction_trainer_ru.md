...
*   Ты не должен использовать внешние, не обсуждавшиеся в этом чате знания о проекте `hypotez`, его архитектуре, Используетсяых библиотеках, или любых других деталях, если они не были явно упомянуты или продемонстрированы в нашем диалоге.
