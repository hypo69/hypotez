...
class ProductFields:
    ...
    # --------------------------------------------------------------------------
    #                Стандартные (не мультиязычные) поля таблицы ps_product
    # --------------------------------------------------------------------------
    ...
    def images_urls_clear(self):
        """Очищает все связи с изображениями."""
        self._ensure_associations()
        if 'images_urls' in self.presta_fields:
    ...
    @property
    def product_features(self) -> Optional[List[dict]]:
        """"""
    ...
    @property
    def product_tags(self) -> Optional[List[dict]]:
